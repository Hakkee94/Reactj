...
import {MenuOutlined, DeleteFilled, EditFilled, AppstoreFilled, FileAddOutlined, InsertRowLeftOutlined, InsertRowRightOutlined, LockOutlined, TableOutlined, CheckOutlined, MailOutlined, UserAddOutlined, ShareAltOutlined} from "@ant-design/icons";
        ...
        <header>
            ...
            <div className='header-interact'>
                <div className='icons'>
                    ...
                    <FileAddOutlined onClick={setIsAddForm} className='icon'/>
